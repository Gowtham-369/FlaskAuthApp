...
setup(
    name='FlaskAuthApp',  # Replace with your package's name
    version='0.1',  # Your package's version
    description='A short description of your package',  # A brief description
    author='Gowtham Reddy Uppunuri',  # Your name
    author_email='your.email@example.com',  # Your email
    url='https://github.com/Gowtham-369/FlaskAuthApp',  # URL to your package's repository
